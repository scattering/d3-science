...
function editor(data, autosize_modules) {
  ...
  */
  ...
  //expands the combined module into a wired template
  function expandCombinedModule(){
	...
	for(var i = 0; i < mods.length; i++){
		...
		var curModule = mods[i];
		console.log("curModule: " + curModule.title);
	}
  }
...
function editor(data, autosize_modules) {
  ...
  */
  ...
  return editor;
>>>>>>> 34a57a68a7e5acbaa37d0223d6065bceee6cee93
}